  ...
  var e = {
      163: (e) => {
        e.exports = function (e) {
          ...
          function a(t) {
            ...
            return (
              t &&
                ((o += r + e.collapsibleClass), (o += r + e.isCollapsedClass)),
          ...
          return {
            ...
            updateToc: function (s) {
                    ...
                    "auto" === e.fixedSidebarOffset &&
                      ...
                      n > e.fixedSidebarOffset
                        ? -1 === l.className.indexOf(e.positionFixedClass) &&
                          (l.className += r + e.positionFixedClass)
              ...
              if (i && null !== t && f.length > 0) {
                ...
                p &&
                  -1 === p.className.indexOf(e.activeLinkClass) &&
                  (p.className += r + e.activeLinkClass);
                var C = p && p.parentNode;
                C &&
                  -1 === C.className.indexOf(e.activeListItemClass) &&
                  (C.className += r + e.activeListItemClass);
                ...
                n.call(g, function (t) {
                  ...
                  p &&
                    p.nextSibling &&
                    -1 !==
                      p.nextSibling.className.indexOf(e.isCollapsedClass) &&
                    (p.nextSibling.className = p.nextSibling.className
                      .split(r + e.isCollapsedClass)
                      .join("")),
      ...
      971: function (e, t, n) {
        ...
        (o = []),
                ...
                (s.init = function (e) {
                  if (u) {
                    ...
                    if (null !== p) {
                      ...
                      if (
                        null !== C &&
                        null !== (o = l.selectHeadings(p, r.headingSelector))
                      ) {
          ...
          void 0 === (i = "function" == typeof l ? l.apply(t, o) : l) ||
            (e.exports = i);
      },
      279: (e) => {
        e.exports = function (e) {
                      ...
                      (function (t, l) {
                        for (
                          var i = o(t),
                            ...
                            s = l,
                            a = n(s),
                            c = r - (a ? a.headingLevel : 0);
                          c > 0 && (!(a = n(s)) || r !== a.headingLevel);
      ...
      374: (e, t) => {
        t.initSmoothScrolling = function (e) {
          ...
          document.body.addEventListener(
            ...
            function (i) {
              var r;
              "a" !== (r = i.target).tagName.toLowerCase() ||
                !(
                  r.hash.length > 0 || "#" === r.href.charAt(r.href.length - 1)
                ) ||
                (o(r.href) !== l && o(r.href) + "#" !== l) ||
